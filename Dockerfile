...
FROM node:24.4-alpine@sha256:820e86612c21d0636580206d802a726f2595366e1b867e564cbc652024151e8a AS base
WORKDIR /app
COPY package*.json ./
RUN npm ci
...
FROM nginx:1.29-alpine-slim@sha256:64daa9307345a975d3952f4252827ed4be7f03ea675ad7bb5821f75ad3d43095 AS prod
